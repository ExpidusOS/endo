...
#ifndef __ENDO_GOBJECT_EXTENSIONS_H__
#define __ENDO_GOBJECT_EXTENSIONS_H__

#include <glib-object.h>

G_BEGIN_DECLS

gboolean  endo_g_value_transform_negate  (const GValue *src_value,
                                         GValue       *dst_value);

G_END_DECLS

#endif /* !__ENDO_GOBJECT_EXTENSIONS_H__ */
