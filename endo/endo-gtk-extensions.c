 ...
 *
 * For example, endo_gtk_file_chooser_add_thumbnail_preview() is a
 ...
 **/
void
endo_gtk_object_destroy_later (GtkWidget *object)
{
                ...
                EndoThumbnailPreview *thumbnail_preview)
{
  ...
  _endo_return_if_fail (GTK_IS_FILE_CHOOSER (chooser));
  ...
  _endo_thumbnail_preview_set_uri (thumbnail_preview, uri);
  g_free (uri);
}
...
/**
 * endo_gtk_file_chooser_add_thumbnail_preview:
 ...
 **/
void
endo_gtk_file_chooser_add_thumbnail_preview (GtkFileChooser *chooser)
{
  ...
  thumbnail_preview = _endo_thumbnail_preview_new ();
  ...
  update_preview (chooser, ENDO_THUMBNAIL_PREVIEW (thumbnail_preview));
}



/**
 * endo_gtk_url_about_dialog_hook:
 ...
 **/
void
endo_gtk_url_about_dialog_hook (GtkAboutDialog *about_dialog,
                               const gchar    *address,
                               gpointer        user_data)
{
  GtkWidget *message;
...
/**
 * endo_gtk_dialog_get_action_area:
 * @dialog : a #GtkDialog.
 *
 ...
 **/
GtkWidget *
endo_gtk_dialog_get_action_area (GtkDialog *dialog)
{
...
/**
 * endo_gtk_dialog_add_secondary_button:
 * @dialog : a #GtkDialog.
 ...
 **/
void
endo_gtk_dialog_add_secondary_button (GtkDialog *dialog,
                                     GtkWidget *button)
{
    GtkWidget *button_box;

    button_box = endo_gtk_dialog_get_action_area (dialog);
...
#define __ENDO_GTK_EXTENSIONS_C__
