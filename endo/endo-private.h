...
#ifndef __ENDO_PRIVATE_H__
#define __ENDO_PRIVATE_H__
...
#ifndef NDEBUG
#define _endo_assert(expr)                  g_assert (expr)
#define _endo_assert_not_reached()          g_assert_not_reached ()
#define _endo_return_if_fail(expr)          g_return_if_fail (expr)
#define _endo_return_val_if_fail(expr, val) g_return_val_if_fail (expr, (val))
#else
#define _endo_assert(expr)                  G_STMT_START{ (void)0; }G_STMT_END
#define _endo_assert_not_reached()          G_STMT_START{ (void)0; }G_STMT_END
#define _endo_return_if_fail(expr)          G_STMT_START{ (void)0; }G_STMT_END
#define _endo_return_val_if_fail(expr, val) G_STMT_START{ (void)0; }G_STMT_END
#endif
...
G_GNUC_INTERNAL void  _endo_i18n_init                    (void);

G_GNUC_INTERNAL void  _endo_gtk_widget_send_focus_change (GtkWidget         *widget,
                                                         gboolean           in);

G_END_DECLS

#endif /* !__ENDO_PRIVATE_H__ */
